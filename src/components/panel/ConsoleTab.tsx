...
export function ConsoleTab({ server, identifier, onPower, busy, live }: ConsoleTabProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-2 border-t border-line-soft px-3 py-3">
          ...
          <input
            ...
            disabled={!isOnline}
            className="min-w-0 flex-1 bg-transparent font-mono text-[13px] text-text-hi placeholder:text-text-lo outline-none disabled:opacity-40"
          />
          <button
            type="button"
            onClick={() => {
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 rounded-xl border border-line bg-panel/60 px-4 py-3.5">

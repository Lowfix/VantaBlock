...
export default forwardRef<HTMLFormElement, Props>(({ title, ...props }, ref) => (
    <Container>
        ...
        <BeforeContent />
        <Form {...props} ref={ref}>
            <div css={tw`md:flex w-full bg-neutral-800 shadow-lg rounded-lg p-6 md:p-10 mx-1`}>
                <div css={tw`flex-none select-none mb-6 md:mb-0 md:mr-10 self-center`}>
                    <img src={'/assets/svgs/vantablock.svg'} css={tw`block w-28 md:w-36 mx-auto`} />
                </div>
